...
class _transferOwnershipState extends State<transferOwnership> {
  ...
  generateDocument(villegename, price, sellername, buyername, selleraddress,
      buyeraddress, surveyno, area, date, sellerphone, buyerphone) async {
    pdf.addPage(pw.Page(
              ...
              children: [
                ...
                pw.Table(columnWidths: {
                  ...
                  tableRow("7)Buyer name and Address",
                      buyername + ',' + buyeraddress + ',Phone no.:' + buyerphone),
                  tableRowSizedBox(),
  ...
  Widget sellerProfile(
      sellerOrBuyer, walletAddres, name, age, city, nic, phone, docu, mail) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          CustomTextFiled(nic.toString(), 'NIC Number'),
          CustomTextFiled(phone.toString(), 'Phone'),
          TextButton(
            onPressed: () {
