...
class MetaMaskProvider extends ChangeNotifier {
  ...
  final abi = [
    ...
    "function UserMapping(address) public view returns(address id,string name,uint age,string city,string nicNumber,string phoneNumber,string document,string email,bool isUserVerified)",
    ...
    "function registerUser(string memory _name, uint _age, string memory _city,string memory _nicNumber, string memory _phoneNumber, string memory _document, string memory _email) public",
  ...
  registerUser(String name, String age, String city, String nic, String phone,
      String document, String email) async {
    await contract.send(
      'registerUser',
      [name, age, city, nic, phone, document, email],
    );
  }
