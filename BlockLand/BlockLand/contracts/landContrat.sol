...
contract Land {
    ...
    function registerUser(string memory _name, uint _age, string memory _city,string memory _nicNumber, string memory _phoneNumber, string memory _document, string memory _email
    ) public {
        ...
        UserMapping[msg.sender] = User(msg.sender, _name, _age, _city,_nicNumber,_phoneNumber, _document,_email,false);
