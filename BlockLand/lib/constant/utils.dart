...
Widget CustomButton(text, fun) => Container(
      constraints: const BoxConstraints(maxWidth: 250.0, minHeight: 25.0),
...
class Menu {
  ...
  Menu({required this.title, required this.icon, this.color});
}
